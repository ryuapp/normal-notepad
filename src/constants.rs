...
pub const ID_EDIT_SELECTALL: i32 = 6;
pub const ID_EDIT_COPY: i32 = 7;
pub const ID_EDIT_CUT: i32 = 8;
pub const ID_EDIT_PASTE: i32 = 9;
pub const ID_VIEW_WORDWRAP: i32 = 10;
pub const ID_VIEW_STATUSBAR: i32 = 11;
